/**
 * Женский парный рейтинг формируется из таблицы «Детализация женских парных турниров»
 * (localStorage fdso_women_doubles_tournaments). Сортировка по Сумма 75%.
 */
(function () {
  'use strict';
  ...
  function load() {
    var tbody = document.querySelector('#women-doubles-panel .rating-table tbody');
    if (!tbody) return;
    var data = null;
    try {
