/**
 * Женский рейтинг формируется из таблицы «Детализация женских турниров»
 * (localStorage fdso_women_tournaments). Сортировка по Сумма 75%.
 */
(function () {
  'use strict';
  ...
  function load() {
    var tbody = document.querySelector('#women-panel .rating-table tbody');
    if (!tbody) return;
    var data = null;
    try {
