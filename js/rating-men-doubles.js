/**
 * Мужской парный рейтинг формируется из таблицы «Детализация мужских парных турниров»
 * (localStorage fdso_men_doubles_tournaments). Сортировка по Сумма 75%.
 */
(function () {
  'use strict';
  ...
  function load() {
    var tbody = document.querySelector('#men-doubles-panel .rating-table tbody');
    if (!tbody) return;
    var data = null;
    try {
