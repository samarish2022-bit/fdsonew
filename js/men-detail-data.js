/**
 * Загрузка таблицы детализации мужских турниров из localStorage (редактируемой в админке).
 * Ключ: fdso_men_tournaments. Если данных нет — остаётся встроенная в HTML таблица.
 */
(function () {
  'use strict';
  ...
  function load() {
    ...
    var theadDates = document.getElementById('men-detail-thead-dates');
    var tbody = document.getElementById('men-detail-tbody');
